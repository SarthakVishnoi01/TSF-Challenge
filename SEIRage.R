...
parameter_list = c (beta1 = beta_value, beta2 = beta_value, beta3 = beta_value, beta4 = beta_value, gamma = gamma_value, delta = delta_value)
...
tbu1<- as.numeric(newIndia.xts$Total.Confirmed)/966000130
length(tbu1)
...
plot(dates, S, type='b', ylim = c(0,1), xlim = as.Date(c("2020-03-12", "2020-08-28")), col='blue', xlab="Date", ylab="S, E, I, R", main = "SEIR epidemic model")
par (new = TRUE)
plot(dates, E, type='b', ylim = c(0,1), xlim = as.Date(c("2020-03-12", "2020-08-28")), col='pink', xlab="", ylab="")
par (new = TRUE)
plot(dates, I, type='b', ylim = c(0,1), xlim = as.Date(c("2020-03-12", "2020-08-28")), col='red', xlab="", ylab="")
par (new = TRUE)
plot(dates, R, type='b', ylim = c(0,1), xlim = as.Date(c("2020-03-12", "2020-08-28")), col='green', xlab="", ylab="")
par (new = TRUE)
...
barplot(
  ...
  names.arg = time[seq(1,length(dates),by=10)],
  xlab='time',main='Population structure', 
  space=0,
  col=c(
    rgb(0.5,1,0.5),
    rgb(0,1,0),
